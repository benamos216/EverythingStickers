...
class YITH_PayPal_Admin {
	...
	public function register_panel() {
		...
		$admin_tabs = array(
			...
			'appearance'      => array(
				'title' => __( 'Appearance', 'yith-paypal-payments-for-woocommerce' ),
				'icon'  => 'configuration',
			),
		);
	...
	public function login_merchant_from_query() {
		...
		if ( ! isset( $_GET['page'] ) || ! isset( $_GET['merchantIdInPayPal'] ) || ! in_array( sanitize_text_field( wp_unslash( $_GET['page'] ) ), array(
	...
	public function show_onboarding_content() {
		wp_safe_redirect( add_query_arg( array( 'page' => 'bluehost#/store/details' ), admin_url( 'admin.php' ) ) );
		exit;
